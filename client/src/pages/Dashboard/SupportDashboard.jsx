      ...
      <div className="max-w-[1400px] mx-auto py-8 lg:py-12 px-4 sm:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="xl:col-span-2 relative bg-white rounded-[3rem] p-6 md:p-8 overflow-hidden shadow-xl shadow-slate-200/50 border border-slate-100"
          >
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6 min-h-[500px]">
                {/* Left Pane: Ticket List */}
                <div className={`lg:col-span-5 flex flex-col ${activeTicket ? 'hidden lg:flex' : 'flex'}`}>
                  {/* Search Bar */}
                ...
                {/* Right Pane: Ticket Inspector & Replies */}
                <div className={`lg:col-span-7 flex flex-col h-full ${activeTicket ? 'flex' : 'hidden lg:flex border-l border-slate-100 lg:pl-6'}`}>
                  {!activeTicket ? (
                    ...
                    <div className="flex flex-col h-full justify-between">
                      ...
                      <div className="space-y-4 flex-1">
                        ...
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
                          ...
                          <div className="bg-white p-3 rounded-xl border border-slate-100 text-xs text-slate-600 font-medium leading-relaxed max-h-[100px] overflow-y-auto whitespace-pre-wrap shadow-inner">
